...
<head>
    ...
    <title>Daftar - LKS SMK 2025</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            line-height: 1.6;
            overflow-x: hidden;
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('image/img2.jpg') no-repeat center center fixed;
    ...
    <div class="register-container">
        ...
        <form action="daftar.php" method="post">
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" required autofocus value="<?php echo isset($username) ? $username : ''; ?>">
            </div>
