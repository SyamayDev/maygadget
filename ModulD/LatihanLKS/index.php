...
<div class="ad-popup" id="adPopup">
    <div class="ad-popup-content">
        <span class="ad-close" id="adClose">&times;</span>
        <a href="login.php">
            <img src="image/ad_popup.jpg" alt="Advertisement">
        </a>
    </div>
</div>
<?php endif; ?>
    ...
    <div class="thumbnail">
        <div class="item">
            ...
            <div class="content">
                ...
                <div class="description">Promo Laptop Gaming</div>
            </div>
        </div>
        <div class="item">
            <img src="image/img2.jpg">
            <div class="content">
                ...
                <div class="description">Promo HandPhone Termurah</div>
            </div>
        </div>
        <div class="item">
            <img src="image/img3.jpg">
            <div class="content">
                ...
                <div class="description">Promo Headset Terbaik</div>
            </div>
        </div>
        <div class="item">
            <img src="image/img4.jpg">
            <div class="content">
                ...
                <div class="description">Promo SmartWatch Termurah</div>
            </div>
        </div>
    </div>
    <div class="arrows">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (adClose) {
            adClose.addEventListener('click', closeAdPopup);
            showAdPopup();
        }
